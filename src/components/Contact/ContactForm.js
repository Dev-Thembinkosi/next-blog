...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      />
      <input type="submit" value="Send Request" className="mt-8 font-medium inline-block capitalize text-xl py-3 px-8 border-2 border-solid border-dark rounded curoser-pointer" />
    </form>
  );
}

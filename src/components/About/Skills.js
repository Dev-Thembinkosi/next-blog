...
export const Skills = () => {
  return (
    <section className="w-full flex flex-col p-5 xs:p-10 sm:p-12 md:p-16 lg:p-20 border-b-2 border-solid dark:border-light border-dark text-dark  dark:text-light">
      <span className="font-semibold text-lg sm:3xl md:text-4xl text-accent dark:text-accentDark">
        I'm comfortable in...
      </span>
